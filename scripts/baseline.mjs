...
run('ir-tests', process.execPath, ['--test', 'tests/ir-v2.test.mjs', 'tests/numeric-pipeline.test.mjs', 'tests/integer-lowering.test.mjs', 'tests/wasm-backend.test.mjs', 'tests/command-arguments.test.mjs', 'tests/primitive-values.test.mjs', 'tests/string-values.test.mjs', 'tests/array-values.test.mjs', 'tests/object-values.test.mjs']);
